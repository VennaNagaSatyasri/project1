...
btn.addEventListener("click", function () {
  ...
  if (name.value == "") {
    document.getElementById("nameid").innerHTML = "Please enter ur name";
  } else {
  ...
  if (pass.value == "") {
    ...
    document.getElementById("passid").innerHTML = "Please enter ur password";
  } else {
    document.getElementById("passid").innerHTML = "";
  }
  let sel = document.getElementById("sel");
  if (sel.value == "Branch") {
    document.getElementById("selid").innerHTML = "Please select ur branch";
  } else {
  ...
  if (rad1.checked == false && rad2.checked == false && rad3.checked == false) {
    document.getElementById("radid").innerHTML = "Please select ur gender";
  } else {
  ...
  if (che1.checked == true || che2.checked == true || che3.checked == true) {
    ...
    document.getElementById("cheid").innerHTML = "Please select ur intrests";
  }
});
